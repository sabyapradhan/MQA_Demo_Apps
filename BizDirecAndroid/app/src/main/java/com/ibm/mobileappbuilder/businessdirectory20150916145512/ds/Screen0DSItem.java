...
public class Screen0DSItem implements Parcelable, IdentifiableBean {
    ...
    public static final Creator<Screen0DSItem> CREATOR = new Creator<Screen0DSItem>() {
        @Override
        public Screen0DSItem createFromParcel(Parcel in) {
            Screen0DSItem item = new Screen0DSItem();
        ...
        @Override
        public Screen0DSItem[] newArray(int size) {
            return new Screen0DSItem[size];
        }
    };
