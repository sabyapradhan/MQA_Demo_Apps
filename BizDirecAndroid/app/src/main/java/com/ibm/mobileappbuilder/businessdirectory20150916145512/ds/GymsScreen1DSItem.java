...
public class GymsScreen1DSItem implements Parcelable, IdentifiableBean {
    ...
    public static final Creator<GymsScreen1DSItem> CREATOR = new Creator<GymsScreen1DSItem>() {
        @Override
        public GymsScreen1DSItem createFromParcel(Parcel in) {
            GymsScreen1DSItem item = new GymsScreen1DSItem();
        ...
        @Override
        public GymsScreen1DSItem[] newArray(int size) {
            return new GymsScreen1DSItem[size];
        }
    };
